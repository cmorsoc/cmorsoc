# ¡Hola! Soy Carlos Morales Socorro 👋

Bienvenido a mi perfil de GitHub. Soy **Licenciado en Informática** de formación, **Profesor de Matemáticas** de profesión y **Astrónomo** de corazón. 
...
* **Plataformas de Aprendizaje:** Creador y coordinador de los proyectos **EVAGD** (Entorno Virtual de Aprendizaje de Gestión Distribuida) y **Abriendo la Escuela**.
* **Formación:** Formador de profesorado en **Aprendizaje Basado en Proyectos (ABP)**, GNU/Linux, Moodle, Scratch...

### 🎓 Trayectoria y reconocimientos
* **Licienciatura:** Informática por la ULPGC (¡Old School player!)
* **Premios Destacados:**
    * **Premio Acción Magistral** (2019).
    * **Winner Astro PI Challenge** (ESA, 2017-2018).
    * **Premio ODS España** y Finalista europeo (2015).
    * **Premio Giner de los Ríos** (2008).
    * **Mejor experiencia matemática de aula** (2007, 2015).

### 📫 Conectemos
* 💼 Trayectoria profesional detallada en [LinkedIn](https://www.linkedin.com/in/cmorsoc).
* 📝 Antes, cuando tenía tiempo, escribía notas y reflexiones en mi [blog personal](http://cmorsoc.blogspot.com).

---
*"Curioso hasta la médula y eterno aprendiz."*
